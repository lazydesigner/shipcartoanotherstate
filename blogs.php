...
<head>
    ...
    <link rel="stylesheet" href="https://shipcartoanotherstate.com/assets/css/blogs.css">
...
<?php include './navbar.php' ?>
    ...
    <section class="blogs-list blog-section">
        ...
        <div class="blog-body row">
            ...
            <div class="blog-item">
                ...
                <div class="blog-detail">
                    ...
                    <a href="commonblogs"><button>Read More</button></a>
                </div>
            </div>
            <div class="blog-item">
            ...
            <div class="blog-item">
                ...
                <div class="blog-detail">
                    ...
                    <p>TERMINAL TO TERMINAL AUTO SHIPPING In USA</p>
                    <a href=""><button>Read More</button></a>
                </div>
            </div>
            <div class="blog-item">
