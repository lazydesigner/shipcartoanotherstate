<header>
        <div class="basic-info">
            ...
            <ul>
                <li><a href="facebook.com"><span style="opacity: 0;">.</span><i class="ri-facebook-fill"></i></a></li>
                <li><a href="instagram.com"><span style="opacity: 0;">.</span><i class="ri-instagram-line"></i></a></li>
                <li><a href="youtube.com"><span style="opacity: 0;">.</span><i class="ri-youtube-line"></i></a></li>
            </ul>
        </div>
        <nav>
            <div class="formobile">
